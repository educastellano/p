...
P.plugins.view.Form = P.inherits(P.View, {
    ...
    //            required: true,
    //            val: function () {
    //                  // for a different way to get the value
    //                  // extra validation here. If not valid, Set 'this.invalid = true'
    //            }
    //        }
    //    },
    //    extraValidate: function () {
    //        // extra or 'multiple fields' validation
    ...
    validate: function (values) {
        ...
        if (this.extraValidate) {
            return this.extraValidate(values);
        }
